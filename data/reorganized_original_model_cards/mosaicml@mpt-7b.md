...
This model was trained by MosaicML’s NLP team on the [MosaicML platform](https://www.mosaicml.com/training) for LLM pretraining, finetuning, and inference.
...
### Model type:
MPT-7B is a decoder-style transformer pretrained from scratch.
...
This model was trained on 440 A100-40GBs.
...
### Recommendations:
Please cosult an attorney before using this model for commercial purposes. We are not responsible for the actions of third parties who use this model.
